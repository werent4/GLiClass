...
pipeline = ZeroShotClassificationPipeline(
    model, tokenizer, classification_type="multi-label", device="cuda"
)
...
examples = [
    ...
    [text2, "business, computers, sport, politics, science", 0.5, False],
    [text3, "business, biology, science, politics, positive review", 0.5, False],
]
