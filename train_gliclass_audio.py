...
def main(args):
    ...
    if args.model_name is not None:
        ...
        encoder_config = ClapTextConfig.from_pretrained(args.encoder_model_name)
        audiocfg = ClapAudioConfig.from_pretrained(args.audio_model_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--focal_loss_alpha', type=float, default=0)#0.9)
    parser.add_argument('--focal_loss_gamma', type=float, default=2)#2.5)
    parser.add_argument('--contrastive_loss_coef', type=float, default=0.15)
    parser.add_argument('--max_length', type=int, default=1024)
    parser.add_argument('--sampling_rate', type= int, default= 48000)
    parser.add_argument('--max_duration_s', type= int, default= 5, help="Max allowed duration of audio segment in seconds")
